...
public class PostinformationtabQuduan implements java.io.Serializable {
	...
	/** default constructor */
	public PostinformationtabQuduan() {
	}

	/** minimal constructor */
	public PostinformationtabQuduan(String fid) {
		this.fid = fid;
	}

	/** full constructor */
	public PostinformationtabQuduan(String fid, String fcreateOrgId, String fcreateOrgname,
			...
			String fpostNameState, String fpostNameEnd, String fpostId, Float fcubeSum, Float ftonnageSum,
			Float fspanSum, String fzhuangState, String fpointCut, String basicsSubPageName, String basicsSubPageState,
			String towerSubPageName, String towerSubPageState, String stringingSubPageName,
			String stringingSubPageState, String basicsSubPageId, String towerSubPageId, String stringingSubPageId,
			Integer fbasicsSubPlanSum, Integer ftowerSubPlanSum, Integer fstringingSubPlanSum, String fmd5,
			Float fzhuangJdjichu, Float fzhuangJdzuta, Float fzhuangJdjiaxian) {
		this.fid = fid;
		...
		this.fpostNameState = fpostNameState;
		this.fpostNameEnd = fpostNameEnd;
	...
	public String getFpostNameState() {
		return this.fpostNameState;
	}

	public void setFpostNameState(String fpostNameState) {
		this.fpostNameState = fpostNameState;
	}


	public String getFpostNameEnd() {
		return this.fpostNameEnd;
	}

	public void setFpostNameEnd(String fpostNameEnd) {
		this.fpostNameEnd = fpostNameEnd;
	}
