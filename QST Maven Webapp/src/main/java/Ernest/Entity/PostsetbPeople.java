...
public class PostsetbPeople implements java.io.Serializable {
	...
	/** default constructor */
	public PostsetbPeople() {
	}

	/** minimal constructor */
	public PostsetbPeople(String fid) {
		this.fid = fid;
	}

	/** full constructor */
	public PostsetbPeople(String fid, String fno, String fpostName,
			String fpostWriteName, String fpostWriteId, String fpostCode, String fpostId, String fpostState,
			String fpostType, String fmasterId, String fcreateTime, String fprojectName, String fprojectCode,
			String fprojectId, String froleName, String froleId, String fmd5, String fphone, String fpostxmid1,
			String fpostxmid2, String frenyn, String fimage) {
		this.fid = fid;
		this.fno = fno;
	...
	public String getFrenyn() {
		return this.frenyn;
	}

	public void setFrenyn(String frenyn) {
		this.frenyn = frenyn;
	}
